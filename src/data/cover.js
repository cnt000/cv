export const covers = {
  summary: `__Senior frontend developer, full-stack developer, tech lead, JavaScript lover and Bologna JS Community Organizer__ with more than 10 years of experience in multinational companies...`,
  paragraphs: [
    "After successfully completing my Master’s Degree in Computer Science at the University of Bologna, I worked for 3 years as full-stack developer at [CINECA](https://www.cineca.it) creating PHP and JQuery web app for pharma industries.",
    "From 2011 and 2020 I worked in the technology department of [YOOX NET-A-PORTER GROUP](https://www.ynap.com), a multinational e-commerce company selling for fashion and luxury. There I learned a lot of things about frontend, agile, working in a team and colaborating with a lot of teams, coding, mentoring. After 2 years I join a tech lead position, creating a new team, managing and continuing evolving with the company.",
    `From 2020 for one year I worked in [Monrif](https://www.monrif.it), a company that manages 5 newspaper and a lot of digital initiatives. We rewrited the frontend platform for the newspapers online with Typescript, React, Next.js and SSR.
